...
<!-- Mirrored from demo.hasthemes.com/boighor-preview/boighor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Dec 2019 21:26:52 GMT -->
<head>
	<meta charset="utf-8">
		...
		<section class="wn__product__area brown--color pt--80  pb--30">
			<div class="container">
				...
				<div class="furniture--4 border--round arrows_style owl-carousel owl-theme mt--50">
					...
					<?php
						$q = $db->prepare("SELECT * FROM kitap");
    if ( $q->execute() ){
      while ($row = $q->fetch()) {
      	echo '
					...
					<div class="product product__style--3">
						<div class="product__thumb">
							<a class="first__img" href="single-product.html"><img src="upload/'.$row['kitap_foto'].'"
									alt="product image"></a>
							...
							<div class="action">
								<div class="actions_inner">
									...
									<div style="width:50px; float:left;">
										...
										<input type ="submit" name ="buton" value="satınal">
										</form>
										</div>
									<div style="width:50px; float:left;">
										<form action="index2.php" method="post">
										<input type ="submit" name ="buton" value="begen">
										</form>'.$row['begen'].'
										</div>
...
if (isset($_POST['buton'])) {
			...
			$guncelle = $db->exec("update kitap set begen = begen +1 ");
}
...
<!-- Mirrored from demo.hasthemes.com/boighor-preview/boighor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Dec 2019 21:27:18 GMT -->
</html>